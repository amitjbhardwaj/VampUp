...
type NavigationProps = StackNavigationProp<RootStackParamList, "PaymentModeAdminScreen">;

const PaymentModeAdminScreen = () => {
            ...
            <View style={[styles.container, { backgroundColor: theme.background }]}>
                ...
                {selectedMode && (
                    <Pressable
                        ...
                        onPress={() => {
                            if (selectedMode === "UPI") {
                                navigation.navigate("UPIPaymentAdminScreen", { _id, projectId, fund });
                            } else if (selectedMode === "Net Banking") {
                                navigation.navigate("NetBankingPaymentAdminScreen", { _id, projectId, fund });
                            } else if (selectedMode === "Debit Card") {
                                navigation.navigate("DebitCardPaymentAdminScreen", { _id, projectId, fund });
                            } else if (selectedMode === "Credit Card") {
                                navigation.navigate("CreditCardPaymentAdminScreen", { _id, projectId, fund });
                            } else if (selectedMode === "Wallets") {
                                navigation.navigate("WalletsPaymentAdminScreen", { _id, projectId, fund });
                            } else if (selectedMode === "NEFT") {
                                navigation.navigate("NEFTPaymentAdminScreen", { _id, projectId, fund });
                            } else if (selectedMode === "RTGS") {
                                navigation.navigate("RTGSPaymentAdminScreen", { _id, projectId, fund });
                            } else if (selectedMode === "IMPS") {
                                navigation.navigate("IMPSPaymentAdminScreen", { _id, projectId, fund });
                            } else {
...
export default PaymentModeAdminScreen;
