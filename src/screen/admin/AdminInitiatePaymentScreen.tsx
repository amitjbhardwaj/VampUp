...
const AdminInitiatePaymentScreen = () => {
                        ...
                        <View style={[styles.projectCard, { backgroundColor: theme.card, borderLeftColor: theme.primary }]}>
                            ...
                            <Pressable
                                ...
                                onPress={() => {
                                    ...
                                    navigation.navigate("PaymentModeAdminScreen", { _id: item._id, projectId: item.project_Id, fund: fund });
                                }}
                            >
...
export default AdminInitiatePaymentScreen;
